...
module CrowdFlow::main_tests {
    ...
    fun test_scenario_create_pool(scenario: &mut Scenario, init_a: u64, init_b: u64) {
        ...
        let lp = main::create_pool(&mut factory, init_a, init_b, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = main::EZeroInput)]
    ...
    #[test]
    #[expected_failure(abort_code = main::EPoolAlreadyExists)]
    fun test_create_pool_aborts_on_duplicate_pair() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let lp = main::create_pool(&mut factory, init_a, init_b, ctx); // aborts here
            transfer::public_transfer(coin::from_balance(lp, ctx), sender(ctx));
    ...
    #[test]
    #[expected_failure(abort_code = main::EInvalidPair)]
    ...
    fun test_create_pool() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let (amount_a, amount_b, lp_supply) = main::pool_balances(&pool);
            assert!(amount_a == 200, 0);
            assert!(amount_b == 100, 0);
            assert!(lp_supply == 141, 0);

            let fee_points = main::pool_fees(&pool);
    ...
    fun test_add_liquidity_aborts_on_zero_input_a() {
        ...
        next_tx(&mut scenario, ADDR2);
        {
            ...
            let (remaining_a, remaining_b, lp) = main::add_liquidity(&mut pool, input_a, input_b, 0);
    ...
    fun test_add_liquidity_on_empty_pool() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let (a_out, b_out) = main::remove_liquidity(&mut pool, coin::into_balance(lp_coin), 0, 0);
        ...
        next_tx(&mut scenario, ADDR2);
        {
            ...
            let (remaining_a, remaining_b, lp) = main::add_liquidity(&mut pool, input_a, input_b, 141);
    ...
    fun test_add_liquidity() {
        ...
        next_tx(&mut scenario, ADDR2);
        {
            ...
            let input_a = balance::create_for_testing<A>(200);
            let input_b = balance::create_for_testing<B>(100);
            let (remaining_a, remaining_b, lp) = main::add_liquidity(&mut pool, input_a, input_b, 140);
        ...
        next_tx(&mut scenario, ADDR2);
        {
            ...
            let (remaining_a, remaining_b, lp) = main::add_liquidity(&mut pool, input_a, input_b, 70);
    ...
    #[test]
    #[expected_failure(abort_code = main::EExcessiveSlippage)]
    fun test_add_liquidity_aborts_on_min_lp_out() {
        ...
        next_tx(&mut scenario, ADDR2);
        {
            ...
            let (remaining_a, remaining_b, lp) = main::add_liquidity(&mut pool, input_a, input_b, 201); // aborts here
    ...
    fun test_remove_liquidity_aborts_on_zero_input_lp() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let lp = balance::zero();
            let (a_out, b_out) = main::remove_liquidity(&mut pool, lp, 0, 0); // aborts here
    ...
    fun test_remove_liquidity() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let (a_out, b_out) = main::remove_liquidity(&mut pool, lp_in, 36, 4);
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let (a_out, b_out) = main::remove_liquidity(&mut pool, lp_in, 2, 0);
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let (a_out, b_out) = main::remove_liquidity(&mut pool, lp_in, 62, 9);
    ...
    fun test_remove_liquidity_aborts_on_min_a_out() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let (a_out, b_out) = main::remove_liquidity(&mut pool, lp_in, 51, 50); // aborts here
    ...
    fun test_remove_liquidity_aborts_on_min_b_out() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let lp_in = coin::into_balance(coin::split(&mut lp_coin, 50, ctx));
            let (a_out, b_out) = main::remove_liquidity(&mut pool, lp_in, 50, 51); // aborts here
    ...
    fun test_swap_a_for_b_aborts_on_zero_input_a() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let input_a = balance::zero<A>();
            let b_out = main::swap_a_for_b(&mut pool, input_a, 0);
    ...
    fun test_swap_b_for_a_aborts_on_zero_input_b() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let input_b = balance::zero<B>();
            let a_out = main::swap_b_for_a(&mut pool, input_b, 0);
    ...
    #[test]
    #[expected_failure(abort_code = main::ENoLiquidity)]
    fun test_swap_a_for_b_aborts_on_zero_pool_balances() {
        ...
        next_tx(&mut scenario, ADDR1);
        {
            ...
            let input_a = balance::create_for_testing<A>(10);
            let b_out = main::swap_a_for_b(&mut pool, input_a, 0); // aborts here
    ...
    fun test_swap_a_for_b() {
        ...
        next_tx(&mut scenario, ADDR2);
        {
            ...
            let b_out = main::swap_a_for_b(&mut pool, input_a, 608);
    ...
    fun test_swap_b_for_a() {
        ...
        next_tx(&mut scenario, ADDR2);
        {
            ...
            let a_out = main::swap_b_for_a(&mut pool, input_b, 2294);
